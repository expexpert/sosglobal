                         ...
                         <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                            <thead>
                                <tr class="nk-tb-item nk-tb-head">
                                    ...
                                    <th class="nk-tb-col"><span>IP Address</span></th>
                                    <th class="nk-tb-col"><span>Join Date</span></th>
                              ...
                              <tr class="nk-tb-item">
                                ...
                                <td class="nk-tb-col tb-col-sm">
                                        ...
                                        <td class="nk-tb-col">
                                            ...
                                            <td class="nk-tb-col">
                                            <span class="tb-sub" style="color:green">{{ $value['ip_address'] }}</span>
                                        </td>
                                        <td class="nk-tb-col">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                       <ul class="link-list-opt no-bdr">
                                                                <li><a href="{{action('App\Http\Controllers\backend\CustomerController@edit', $value['id'])}}"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                              
                                                                <li><a href="{{action('App\Http\Controllers\backend\CustomerController@show', $value['id'])}}"><em class="icon ni ni-eye"></em><span>View</span></a></li>
